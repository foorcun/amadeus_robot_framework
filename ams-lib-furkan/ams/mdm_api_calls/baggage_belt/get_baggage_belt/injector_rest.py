...
def injector(kwargs, session_key="defaultKey"):
    ...
    endpoint_type = kwargs.get("endpoint_type", "baggageBeltList")
    ...
    match endpoint_type:
        case "baggageBeltList":
            url_key = "baggage_belt_all"
        case "baggageBeltCount":
            url_key = "baggage_belt_count"
        case "baggageBeltGroup":
            url_key = "baggage_belt_group_all"
