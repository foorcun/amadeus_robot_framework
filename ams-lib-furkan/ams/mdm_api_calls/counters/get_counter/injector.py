"""
This module contains the injector to fetch the counter details
"""
...
def get_counter_details(session_key="defaultKey", **kwargs):
    """
    ...
    === Usage: ===
    | Get Counter Details    expected_response_code=200      endpoint_type=counterList
    | Get Counter Details    expected_response_code=200      endpoint_type=counterCount     path_param=${counterCode}
    | Get Counter Details    expected_response_code=200      endpoint_type=counterGroup     additional_params=${counterCode}
