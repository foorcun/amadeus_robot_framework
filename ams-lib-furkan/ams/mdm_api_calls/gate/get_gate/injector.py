"""
This module contains the injector to fetch the gate details
"""
...
def get_gate_details(session_key="defaultKey", **kwargs):
    """
    Get Gate entity details.
    ...
    === Usage: ===
    | Get Gate Details    expected_response_code=200      endpoint_type=gateList
    | Get Gate Details    expected_response_code=200      endpoint_type=gateCount     path_param=${gateName}
    | Get Gate Details    expected_response_code=200      endpoint_type=gateGroup     additional_params=${gateName}
