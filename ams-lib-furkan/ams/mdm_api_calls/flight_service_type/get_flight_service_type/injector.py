"""
This module contains the injector to fetch the flight service type
"""
...
def get_flight_service_type(session_key="defaultKey", **kwargs):
    """
    Get Flight Service Type
    ...
    === Usage: ===
    | Get Flight Service Type       expected_response_code=200      endpoint_type=list
    | Get Flight Service Type       endpoint_type=list
