"""
This module contains the injector to fetch the stand details
"""
...
def get_stand_details(session_key="defaultKey", **kwargs):
    """
    Get Stand entity details.
    ...
    === Usage: ===
    | Get Stand Details    expected_response_code=200      endpoint_type=stand
    | Get Stand Details    expected_response_code=200      endpoint_type=stand     additional_params=${standId}
    | Get Stand Details    expected_response_code=200      endpoint_type=name     path_param=${standName}
